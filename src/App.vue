  ...
  <div class="captcha-container">
    ...
    <div class="footer">
      <div style="display: flex; align-items: center; gap: 10px;">
        ...
        <a href="https://github.com/VanillaNahida/nahida-captcha" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; justify-content: center; cursor: pointer;">
